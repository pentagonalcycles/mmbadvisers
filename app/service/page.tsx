    ...
    <section className="section">
      <div className="container max-w-4xl">
        ...
        <div className="mt-6 space-y-4 text-[var(--muted)]">
          <p>
            TP Dates CP (Turning Point Dates for Capital Protection) is a risk management advisory service designed to identify time windows with elevated market crash risk and support minimal-intervention protective hedging.
          </p>
          <p>
